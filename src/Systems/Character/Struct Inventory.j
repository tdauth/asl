library AStructSystemsCharacterInventory requires AStructCoreGeneralHashTable, AStructCoreGeneralList, ALibraryCoreGeneralItem, ALibraryCoreGeneralUnit, AStructCoreStringFormat, ALibraryCoreInterfaceTextTag, AStructSystemsCharacterAbstractCharacterSystem, AStructSystemsCharacterCharacter, AStructSystemsCharacterItemType
	...
	struct AInventory extends AAbstractCharacterSystem
		...
		/**
		 * Creates a new inventory for \p character.
		 * This adds the rucksack ability to the character's unit.
		 */
